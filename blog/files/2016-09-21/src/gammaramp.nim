...
discard fb.writePpm("out/linear-ramp32.ppm")
...
discard fb.writePpm("out/gamma-ramp32.ppm")
...
discard fb.writePpm("out/linear-ramp.ppm")
...
discard fb.writePpm("out/linear-ramp32-perceptual.ppm")
